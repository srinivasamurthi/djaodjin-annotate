        ...
        init: function() {
            ...
            if (self.options.useOwnTemplate) {
                ...
                if (self.options.bootstrap) {
                    ...
                    self.$tool = '<div id="tools" style="display:none">' +
            ...
            self.$tool.on('click', '.annotateredo', function(event) {
                self.redoaction(event);
            });
            self.$tool.on('click', '.annotateundo', function(event) {
